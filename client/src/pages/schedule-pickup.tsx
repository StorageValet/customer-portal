...
export default function SchedulePickup() {
  ...
  const schedulePickupMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Your pickup has been scheduled successfully. You'll receive a confirmation email shortly.",
      });
  ...
  const availableItems = items.filter(item => 
    item.status === 'at_home' && !scheduledItemIds.includes(item.id)
  );
